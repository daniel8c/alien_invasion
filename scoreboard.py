...
class Scoreboard:
    """ Class intended to provide information on scoring. """
    ...
    def prep_score(self):
        ...
        # Score display in the upper right corner
    ...
    def prep_high_score(self):
        ...
        # Display of scores on top center
    ...
    def show_score(self):
        """ Display of scores on the screen. """
    ...
    def prep_level(self):
        ...
        # Level display at the top right corner below the score.
        self.level_rect = self.high_score_image.get_rect()
        self.level_rect.right = self.score_rect.right
        self.level_rect.top = self.score_rect.bottom + 10

    def prep_ships(self):
        """ Displaying the number of ships remaining for the player. """
        self.ships = Group()
